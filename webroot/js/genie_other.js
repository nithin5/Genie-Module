...
var actual_link='ch-3';//offer details
...
var state;
    ...
    //$("body").on('click',"#login_popup_leads_select_city2",function(e){
      e.preventDefault();
         $('#mobile_number').css("border-color","#dddddd");
         $('#mob_desc').text('');
         var user_id=$("#QuoteUserId").val();
